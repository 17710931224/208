...
@section('content')
 ...
 <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action='/admin/link' method='post' enctype='multipart/form-data'>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="mws-form-item">
                     <div><img alt="User profile picture"  id="avatar" class="profile-user-img img-responsive" src="" style="float: left; display: none"></div>
