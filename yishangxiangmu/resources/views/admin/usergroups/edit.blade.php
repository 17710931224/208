...
<div class="panel panel-default">
	...
	<div class="panel-body">
	  <form action="/admin/usergroups/update" class="form-horizontal" enctype="multipart/form-data" id="form-user-group" method="post">
	    <div class="form-group required">
	      <label class="col-sm-2 control-label" for="input-name">群组名</label>
	      <div class="col-sm-10"><input class="form-control" id="input-name" name="name" placeholder="群组名" type="text" value="{{$name}}"/></div>
	    </div>
	    ...
	    <div class="form-group">
	        ...
	        <a href="/admin/usergroups/index" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="取消"><i class="fa fa-reply"></i> 取消</a>
	  </form>
	</div>
</div>
@endsection