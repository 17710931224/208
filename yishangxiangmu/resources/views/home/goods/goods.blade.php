                            ...
                            <div class="product-item-container">
                                <div class="left-block left-b">
                                    ...
                                    <div class="so-quickview">
                                      <a class="iframe-link btn-button quickview quickview_handler visible-lg" href="quickview/{{$v->prod_id}}" title="快速浏览" data-fancybox-type="iframe"><i class="fa fa-eye"></i><span>Quick view</span></a>
                                    </div>                                                     
                                    <!--end quickview-->
